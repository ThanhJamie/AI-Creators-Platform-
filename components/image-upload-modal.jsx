  ...
  const onDrop = async (acceptedFiles) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success(
          "Image uploaded successfully. You can now apply transformations."
        );
      } else {
  ...
  const handleSelectImage = () => {
    if (transformedImage) {
      onImageSelected({
        ...
        originalUrl: transformedImage?.url,
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-2">
                      or click to select a file (JPG, PNG, GIF - Max 10MB)
                    </p>
                  </div>
                </div>
              )}
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700 ">
                    ...
                    <p className="text-sm text-slate-400">
                      {watchedValues.backgroundRemoved
                        ...
                        : "Requires background removal to work"}
                    </p>
                  </div>
