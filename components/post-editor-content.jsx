...
import { Icon, ImageIcon, Minus, Plus, Sparkle, Wand2 } from "lucide-react";
  ...
  const handleAI = async (type, improvementType = null) => {
    ...
    if (type === "generate") {
      ...
      if (content && content !== "<p><br></p>") {
        window.confirm(
          "This will replace your current content. Are you sure you want to continue?"
        );
        return;
      }
      ...
      if (!content || content === "<p><br></p>") {
        return toast.error("Please add some content to improve");
      }
      setIsImproving(true);
    }
        ...
        <div className="space-y-5">
          ...
          <div>
            <Input
              ...
              className={
                "border-0 text-4xl font-bold bg-transparent placeholder:text-slate-500 text-white p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0"
              }
          ...
          <div>
            {!hasContent ? (
              <Button
                ...
                size={"sm"}
                className={
                  "border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white disabled:opacity-50 w-full"
                }
              >
              ...
              <div className="grid grid-cols-3 w-full gap-2">
                {[
                  { type: "enhance", icon: Sparkle, color: "green" },
