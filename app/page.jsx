...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-2xl md:max-w-none">
                ...
                and helps you build and thriving creator business.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              From AI-powered content creation to audience engagement and
              monetization, our platform provides all the tools you need to
              succeed as a modern creator.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardHeader>
                  <CardContent>
                    <div
                      className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex 
                                  items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}
                    >
                      <feature.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                    </div>
                  </CardContent>
                  <CardTitle
                    className={"text-lg sm:text-xl mb-3 sm:mb-4 text-white"}
                  >
                    {feature.title}
                  </CardTitle>
                  <CardDescription
                ...
                {platformTabs.map((tab, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center ${activeTab === index ? "bg-gradient-to-br from-purple-500 to-blue-500" : "bg-muted"}`}
                      >
      ...
      {/* Social */}
      <section className="relative z-10 py-16 sm:py-24 px-5 sm:px-6 bg-gradient-to-r from-gray-900/50 to-purple-900/20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 lg:gap-8">
            {socialProofStats.map((stat, index) => (
              <div key={index} className="text-center">
                <div
                  className="w-12 h-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 bg-gradient-to-br from-purple-500 to-blue-500 
          ...
          <div className="flex flex-col items-center justify-center space-y-6">
            ...
            <div className="flex space-x-6">
              {footers.map((footer, index) => {
                ...
                if (footer.title === "Facebook") IconComponent = Facebook;
                if (footer.title === "Instagram") IconComponent = Instagram;
                if (footer.title === "LinkedIn") IconComponent = Linkedin;

                const isEmail = footer.title === "Gmail";
                const href = isEmail ? `mailto:${footer.link}` : footer.link;
                ...
                return (
                  <a
                    ...
                    className="group flex items-center justify-center w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-blue-500 rounded-full transition-all duration-300 hover:scale-110"
                  >
                    <IconComponent className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
                    <span className="sr-only">{footer.title}</span>
                  </a>
                );
              })}
            </div>
            ...
            <p className="text-sm text-gray-500 text-center">
              © 2025 Creatr Platform. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
