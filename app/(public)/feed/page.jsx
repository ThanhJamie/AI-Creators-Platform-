...
const FeedPage = () => {
  ...
  const [activateTab, setActivateTab] = useState("feed");
  ...
  const isLoading =
    feedLoading || (activateTab === "trending" && trendingLoading);
      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className=" text-slate-400">
            Stay up to date with the latest trending posts and explore new
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-8">
          <div className="lg:col-span-4 space-y-6">
            <div className="flex space-x-2">
              <Button
                className={"flex-1"}
                onClick={() => setActivateTab("feed")}
                variant={activateTab === "feed" ? "default" : "outline"}
              >
                For You
              </Button>
              <Button
                className={"flex-1"}
                onClick={() => setActivateTab("trending")}
                variant={activateTab === "trending" ? "primary" : "ghost"}
              >
                <TrendingUp
                  className="h-4 w-4 mr2
              "
                />{" "}
                Trending
              </Button>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {activateTab === "feed" && feedData?.hasMore && (
          ...
          <div className="lg:col-span-2 space-y-6 mt-14">
            <Card className={"card-glass"}>
              ...
              <CardContent>
                {suggestionsLoading ? (
                  <div>
                    <Loader2 className="flex justify-center py-4" />
                  </div>
