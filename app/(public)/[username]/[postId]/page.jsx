...
import { toggleLike } from "@/convex/likes";
...
const PostsPage = ({ params }) => {
  ...
  const {
    ...
    error: commentsError,
  } = useConvexQuery(api.comments.getPostComments, {
    postId,
  });
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right text-sm text-slate-400">
                <div className="flex items-center gap-1 mb1">
              ...
              <CardContent className={"p-6"}>
                <form onSubmit={handleCommentSubmit} className="space-y-4">
                  <Textarea
                    ...
                    className={
                      "bg-slate-800 border-slate-600 text-white placeholder:text-slate-400 resize-none"
                    }
                    rows={3}
                    maxLength={1000}
                  />
